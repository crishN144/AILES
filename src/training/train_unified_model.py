...
Legal Analysis:""",
        ...
        },
        {
            ...
            "max_tokens": 700,
            "prompt_template": """Extract key information from this UK family law judgment XML:

{xml_content}

Task: Create a structured summary of the most important information you can identify from this case. Include whatever relevant details are available such as:
- Case reference/citation (if available)
- Court and judge (if identifiable)  
- Parties and their roles
- Main legal issues
- Key statutes, acts, or legal principles mentioned
- Decision outcome
- Any orders or next steps

Focus on extracting what is actually present rather than forcing a rigid format.
...
Structured Summary:""",
    ...
    for config in pair_configs:
        ...
        try:
            ...
            if len(set(response.split())) < len(response.split()) * 0.6:  # Too repetitive
